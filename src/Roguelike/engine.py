...
def main():
    # screen, map, and room parameters
    screen_width = 80
    screen_height = 50
    map_width = 80
    map_height = 43
    ...
    game_map.make_map(max_rooms, room_max_size, room_min_size, map_width, map_height, player, entities, max_monsters_per_room, max_items_per_room)
    ...
    while not libtcod.console_is_window_closed():
        ...
        render_all(con, panel, entities, player, game_map, fov_map, fov_recompute, message_log, screen_width, screen_height, bar_width, panel_height, panel_y, mouse, colours, game_state)
        fov_recompute = False
