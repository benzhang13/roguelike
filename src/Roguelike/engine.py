    ...
    while not libtcod.console_is_window_closed():
        ...
        if show_main_menu:
            ...
            if show_load_error_message:
                message_box(con, "No saved game to load", 50, constants["screen_width"], constants["screen_width"])
            ...
            play_game(player, entities, game_map, message_log, game_state, constants, con, panel)

            show_main_menu = True


def play_game(player, entities, game_map, message_log, game_state, constants, con, panel):
    fov_recompute = True
