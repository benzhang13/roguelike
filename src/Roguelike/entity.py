...
class Entity:
    """
    A generic object to represent any entity within the game
    """

    def __init__(self, x, y, char, colour, name, blocks, render_order = RenderOrder.CORPSE, fighter = None, ai = None, item = None, inventory = None):
        self.x = x
        self.y = y
        self.char = char
        self.colour = colour
